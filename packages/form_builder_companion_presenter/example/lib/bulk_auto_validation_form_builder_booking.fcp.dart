...
/// for [BulkAutoValidationFormBuilderBookingPresenter].
@sealed
@immutable
class $BulkAutoValidationFormBuilderBookingPresenterFormProperties
    implements FormProperties {
  final FormProperties _underlying;

  /// Gets a [BulkAutoValidationFormBuilderBookingPresenter] instance which holds this properties state.
  BulkAutoValidationFormBuilderBookingPresenter get presenter =>
      _underlying.presenter as BulkAutoValidationFormBuilderBookingPresenter;

  /// Gets a typed [PropertyDescriptor] accessor [$BulkAutoValidationFormBuilderBookingPresenterPropertyDescriptors]
  /// for [BulkAutoValidationFormBuilderBookingPresenter].
  late final $BulkAutoValidationFormBuilderBookingPresenterPropertyDescriptors
      descriptors;

  /// Gets a typed property value accessor [$BulkAutoValidationFormBuilderBookingPresenterPropertyValues]
  /// for [BulkAutoValidationFormBuilderBookingPresenter].
  late final $BulkAutoValidationFormBuilderBookingPresenterPropertyValues
      values;

  /// Returns a [$BulkAutoValidationFormBuilderBookingPresenterFormProperties] which wraps [FormProperties].
  ///
  /// Note that this factory returns [underlying] if [underlying] is
  /// [$BulkAutoValidationFormBuilderBookingPresenterFormProperties] type.
  factory $BulkAutoValidationFormBuilderBookingPresenterFormProperties(
      FormProperties underlying) {
    if (underlying
        is $BulkAutoValidationFormBuilderBookingPresenterFormProperties) {
      return underlying;
    }

    if (underlying.presenter
        is! BulkAutoValidationFormBuilderBookingPresenter) {
      throw ArgumentError(
        'Specified FormProperties does not hold ${BulkAutoValidationFormBuilderBookingPresenter} type presenter.',
        'underlying',
      );
    }

    return $BulkAutoValidationFormBuilderBookingPresenterFormProperties
        ._(underlying);
  }

  $BulkAutoValidationFormBuilderBookingPresenterFormProperties._(
      this._underlying) {
    descriptors =
        $BulkAutoValidationFormBuilderBookingPresenterPropertyDescriptors
            ._(_underlying);
    values = $BulkAutoValidationFormBuilderBookingPresenterPropertyValues
        ._(_underlying);
  }
  ...
  @override
  $BulkAutoValidationFormBuilderBookingPresenterFormProperties copyWithProperty(
    String name,
    Object? newValue,
  ) {
  ...
  /// returned [$BulkAutoValidationFormBuilderBookingPresenterFormPropertiesBuilder] object.
  ///
  /// You must call [$BulkAutoValidationFormBuilderBookingPresenterFormPropertiesBuilder.build]
  /// to finish copying.
  $BulkAutoValidationFormBuilderBookingPresenterFormPropertiesBuilder
      copyWith() =>
          $BulkAutoValidationFormBuilderBookingPresenterFormPropertiesBuilder
              ._(this);
...
/// for [BulkAutoValidationFormBuilderBookingPresenterFormProperties].
@sealed
class $BulkAutoValidationFormBuilderBookingPresenterPropertyDescriptors {
  final FormProperties _properties;

  $BulkAutoValidationFormBuilderBookingPresenterPropertyDescriptors._(
      this._properties);
...
/// for [BulkAutoValidationFormBuilderBookingPresenterFormProperties].
@sealed
class $BulkAutoValidationFormBuilderBookingPresenterPropertyValues {
  final FormProperties _properties;

  $BulkAutoValidationFormBuilderBookingPresenterPropertyValues._(
      this._properties);
...
/// Defines a builder to help [BulkAutoValidationFormBuilderBookingPresenterFormProperties.copyWith].
@sealed
class $BulkAutoValidationFormBuilderBookingPresenterFormPropertiesBuilder {
  final $BulkAutoValidationFormBuilderBookingPresenterFormProperties
      _properties;
  final Map<String, Object?> _newValues = {};

  $BulkAutoValidationFormBuilderBookingPresenterFormPropertiesBuilder._(
      this._properties);
  ...
  $BulkAutoValidationFormBuilderBookingPresenterFormProperties build() =>
...
extension $BulkAutoValidationFormBuilderBookingPresenterPropertyExtension
  ...
  /// Gets a current [$BulkAutoValidationFormBuilderBookingPresenterFormProperties] which holds properties' values
  /// and their [PropertyDescriptor]s.
  $BulkAutoValidationFormBuilderBookingPresenterFormProperties get properties =>
      $BulkAutoValidationFormBuilderBookingPresenterFormProperties(
          propertiesState);

  /// Resets [properties] (and underlying[CompanionPresenterMixin.propertiesState])
  /// with specified new [$BulkAutoValidationFormBuilderBookingPresenterFormProperties].
  ///
  ...
  /// because takes and returns more specific [$BulkAutoValidationFormBuilderBookingPresenterFormProperties] type.
  $BulkAutoValidationFormBuilderBookingPresenterFormProperties resetProperties(
    $BulkAutoValidationFormBuilderBookingPresenterFormProperties newProperties,
  ) {
...
class $BulkAutoValidationFormBuilderBookingPresenterFieldFactory {
  ...
  $BulkAutoValidationFormBuilderBookingPresenterFieldFactory._(
      this._properties);
...
extension $BulkAutoValidationFormBuilderBookingPresenterFormPropertiesFieldFactoryExtension
    on $BulkAutoValidationFormBuilderBookingPresenterFormProperties {
