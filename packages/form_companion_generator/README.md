...
`extra_libraries` | String, or list of string | empty | Specify package uri with `package:...` format which will always be described as `import` directives in generated sources. For example, you can specify your L10N related package imports such as `package:my_package/src/l10n/l10n.dart`.
